...
function MyNominations() {
    ...
    return (
        ...
        <div>
           <Breadcrumb pageNames={['my-nominations']}/>
                            ...
                            {currentPackageData.map((packageItem, key) => (
                                <tr key={key} className="border-b border-[#eee]">
                                    ...
                                    <td className="py-2 md:py-3 px-2 md:px-2"> {/* Adjusted padding for mobile */}
                                        {packageItem.status === "Approved" || packageItem.status === "Pending" ? (
                                        ...
                                        ) : packageItem.status === "Incomplete" ? (
                                            <button className="bg-[green] hover:bg-[lightgreen] hover:text-black text-white font-bold py-1 md:py-2 px-2 md:px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-red-400">
                                                Submit
                                            </button>
                                        ) : null}
                                    </td>
